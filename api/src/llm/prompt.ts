...
8. ประเมิน "ขั้นตอนของลูกค้า" (sales pipeline) จากบทสนทนาทั้งหมด แล้วใส่ค่าใน stage เป็นหนึ่งใน: ถาม | สั่งซื้อ | จัดส่ง | หลังการขาย | ยกเลิก (ถ้าไม่ชัดเจนให้เว้นว่าง "") — ถาม: ถามข้อมูล/ราคา/สินค้า; สั่งซื้อ: ตกลงจะซื้อ/แจ้งรายการที่ต้องการ/รอโอนเงิน; จัดส่ง: ชำระ/กำลังจัดส่ง/ถามเลขพัสดุ; หลังการขาย: ได้รับของแล้ว/สอบถามการใช้งาน/เคลม/ซื้อซ้ำ; ยกเลิก: แจ้งไม่ซื้อ/ยกเลิก. การประเมิน stage ไม่เกี่ยวกับ type ของคำตอบ
...
ตอบ JSON อย่างเดียว: {"type":"draft|needs_human|out_of_scope","draft":"...","used_kb":["KB-..."],"used_products":["SKU-..."],"cross_sell_terms":["..."],"stage":"ถาม|สั่งซื้อ|จัดส่ง|หลังการขาย|ยกเลิก|","note":"..."}`;
