...
// Keep this contract in sync with api/src/finance/receiptReferences.ts. The API is the final
// authority, while this copy lets the chip UI show the exact value that will be persisted.
