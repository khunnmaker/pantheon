...
// gm → Ceres + Minerva + Juno + Apollo; central/staff → their own per-person grant list. Mercury is owner-only
// (only supervisor passes today), so a granted staff is the future path. A stored agent from
