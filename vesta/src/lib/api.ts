...
// sends supervisor/gm/central/staff. Vesta's routes stay supervisor-gated server-side (v1).
...
// gm → Ceres + Minerva + Juno + Apollo; central/staff → their own per-person grant list. A stored agent from before
